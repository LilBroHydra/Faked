...
let x = Bot.getProperty("deptx"+user.telegramid)
...
prof.add(refcom)
  ...
  Bot.sendMessageToChatWithId(referrer.telegramid,"🎖 Congratulation. One of your friend "+user.first_name+" "+user.last_name+" has just invested on bot by using your reffer link and you have earned "+refcom+" "+cur);
